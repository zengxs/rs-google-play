        ...
        || !Path::new("src/android_checkins.bin").exists()
    {
        ...
        for section in config.sections() {
            ...
            android_build.bootloader =
                SingularField::from(config.get(&section, "Build.BOOTLOADER"));
            ...
            android_build.manufacturer =
                SingularField::from(config.get(&section, "Build.MANUFACTURER"));
            ...
            android_checkin.cellOperator =
                SingularField::from(config.get(&section, "CellOperator"));
